...
function App() {
    ...
    return (
        <div className="App">
                        ...
                        <div style={{
                            ...
                            {orders.map(order => (
                                <div key={order.id} style={{
                                    ...
                                    {order.restaurant_name && <p>Restaurant:
            ...
            <footer style={{
                textAlign: 'center', padding: '20px', marginTop:
                    '40px', borderTop: '1px solid #eee'
            }}>
                <p>© 2025 FoodFlash - Powered by hunger and code</p>
                <p>Server Status: <span
                    id="server-status">Checking...</span></p>
            </footer>
